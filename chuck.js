...
//verfificar tamanho da coleção
var tamanho_colecao = curiosidades_chuk_norris.length;

//sortear numero entre numeros da coleção
var numero_sorteado = Math.floor(Math.random() * tamanho_colecao);

//preparando as variaveis 
var curiosidade_escolhida = curiosidades_chuk_norris[numero_sorteado];
...
console.log("CURIOSIDADES CHUCK NORRIS");
